...
extern node *EVALexprstmt (node * arg_node, info * arg_info);
...
extern node *EVALfundefs (node * arg_node, info * arg_info);
...
extern node *EVALids (node * arg_node, info * arg_info);
...
extern node *EVALsymbol (node * arg_node, info * arg_info);
